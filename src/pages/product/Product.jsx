                ...
                {product?.map((c, index) => (
                  <tr key={index}>
                    <td class="border-b border-[#eee] py-5 pl-2 dark:border-strokedark xl:pl-11">
                        <img src={`${url}${c?.product[0]?.img}`} alt="" className="w-[120px] h-[120px] rounded-md object-cover" />
                    </td>
                    <td class="border-b border-[#eee] py-5 pl-2 dark:border-strokedark xl:pl-11">
                    ...
                    <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                      <Link to={`/edit-image/${c?.id}`} class="flex items-center justify-center sm:justify-start space-x-3.5">
                        <button
